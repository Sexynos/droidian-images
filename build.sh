...
wget -nv https://github.com/Sexynos/droidian-kernel-samsung-exynos9810/releases/download/starlte/boot-starlte.img
wget -nv https://github.com/Sexynos/droidian-kernel-samsung-exynos9810/releases/download/starlte/recovery.img
...
mkdir out/ -p
DATE=$(date +'%Y%m%d')
ZIP_NAME="droidian-UNOFFICIAL-phosh-phone-samsung_starlte-api29-arm64-nightly_$DATE.zip"
